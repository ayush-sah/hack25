# Welcome, ultra-minds, to the 2025 TDI Global Hackathon!
...
1. This **[GitHub repository](https://github.com/db-hackathon/ultra-minds)** which you can use to store your code. :bookmark_tabs:
1. A **Terraform Cloud** workspace [see here](https://app.terraform.io/app/db-hackathon-2025/workspaces/hack-team-ultra-minds) allowing you to deploy with [Terraform](https://developer.hashicorp.com/terraform/intro) into [GCP](https://cloud.google.com/docs/terraform). :hammer:
...
You have an **infrastructure SA** `infrastructure@hack-team-ultra-minds.iam.gserviceaccount.com` with the same IAM permissions as team members.
...
This SA is also used when you _provision infrastructure_ using your [Terraform Cloud workspace](https://app.terraform.io/app/db-hackathon-2025/workspaces/hack-team-ultra-minds).

You also have a **workload SA** `workload@hack-team-ultra-minds.iam.gserviceaccount.com` that you can use to attach to your workloads (e.g. Cloud Run revisions).
...
Cloud Function) you must attach your **Workload SA** `workload@hack-team-ultra-minds.iam.gserviceaccount.com` , usually referred to in the GCP documentation as _"attaching a custom SA"_.

Both your [GitHub Actions workflows](./.github/workflows/) and [Terraform Cloud workspace](https://app.terraform.io/app/db-hackathon-2025/workspaces/hack-team-ultra-minds) have pre-populated variables containing the Workload
SA email.
...
* [Cloud Build](https://cloud.google.com/build?hl=en)
    * [gcloud](https://cloud.google.com/build/docs/securing-builds/configure-user-specified-service-accounts)
        * Ensure you specify
          the [--service-account=workload@hack-team-ultra-minds.iam.gserviceaccount.com](https://cloud.google.com/sdk/gcloud/reference/builds/submit#--service-account)
...
* [Vertex AI generally](https://cloud.google.com/vertex-ai/docs/general/custom-service-account#attach)
    * Vertex AI's Console UI does not always expose the field necessary to specify a user managed SA.  
      ...
      (typically `"serviceAccount": "workload@hack-team-ultra-minds.iam.gserviceaccount.com"`, to be added as a peer of the `"name": "..."`
...
```shell
PROJECT_ID="hack-team-ultra-minds"

curl \
-X POST \
-H "Authorization: Bearer $(gcloud auth print-access-token)" \
-H "Content-Type: application/json; charset=utf-8" \
https://europe-west4-aiplatform.googleapis.com/v1/projects/hack-team-ultra-minds/locations/europe-west4/pipelineJobs?pipelineJobId=tune-large-model-$(date +"%Y%m%d%H%M%S") -d \
$'{
    "displayName": "tune-large-model",    
    "serviceAccount": "workload@hack-team-move.iam.gserviceaccount.com", 
    "runtimeConfig": {
        "gcsOutputDirectory": "gs://artifacts.hack-team-ultra-minds.appspot.com/Foo/",
        "parameterValues": {
            "location": "us-central1",
            "project": "hack-team-ultra-minds",
            "large_model_reference": "text-bison@001",
            "model_display_name": "mytunedmodel_1",
            "train_steps": 100,
            "encryption_spec_key_name": "",
            "dataset_uri": "gs://artifacts.hack-team-ultra-minds.appspot.com/Bar.jsonl",
            "evaluation_data_uri": "",
...
2. Configure your default Cloud Shell Google Cloud Project by running `gcloud config set project hack-team-ultra-minds`

#### [GCP Example Apps](https://github.com/db-hackathon/support/tree/main/google-examples) :globe_with_meridians:

TBC

## [GitHub](https://github.com/db-hackathon/ultra-minds) :bookmark_tabs:
...
## [Terraform Cloud](https://app.terraform.io/app/db-hackathon-2025/workspaces/hack-team-ultra-minds)
